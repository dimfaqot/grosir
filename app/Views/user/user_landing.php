...
<?php foreach ($data as $k => $i): ?>
    <div class="card text-bg-dark mb-3" data-menu="<?= $i['nama']; ?>">
        ...
        <div class="card-body d-flex justify-content-between ps-4">
            <div class="text-secondary"><small><?= $i['role'] . " [" . $i['wa'] . "]"; ?></small></div>
            <div>
    ...
    let form_input = (order, id) => {
        ...
        html += `</select>
                    ...
                    <div class="form-floating mb-3">
                     ...
                     <div class="form-floating mb-3">
                        <input type="text" name="wa" ${(order=="Edit"?'value="'+data.wa+'"':"")} class="form-control bg-dark text-light" placeholder="Wa" required>
                        <label class="text-secondary">Wa</label>
                    </div>
                    <div class="form-floating mb-3">
