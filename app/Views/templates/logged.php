        ...
        const message = (status, message, id, tabel, is_reload) => {
            ...
            if (status == "200") {
                ...
                <div class="text-center text-danger pb-4">
                    <p style="font-size:12px">${message}</p>
                    <button style="font-size:12px;" class="btn btn-sm btn-secondary me-1 cancel_confirm">Batal</button>
                    <button style="font-size:12px;" class="btn btn-sm btn-danger btn_delete" data-id="${id}" data-tabel="${tabel}" data-is_reload="${is_reload}" style="width: 50px;">Ya</button>
                </div>`;
            }
