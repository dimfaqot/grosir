...
class Pengeluaran extends BaseController
{
    ...
    public function add()
    {
        ...
        $toko_id = clear($this->request->getVar('toko_id'));
        ...
        $toko = db('toko')->where('id', $toko_id)->get()->getRowArray();
        ...
        if (!$toko) {
            gagal(base_url(menu()['controller']), "Toko not found");
        }
    ...
    public function edit()
    {
        ...
        if (!$toko)      return gagal(base_url(menu()['controller']), "Toko not found");
    ...
    public function list()
    {
        ...
        $data = db(strtolower('pengeluaran'))->select('*')
